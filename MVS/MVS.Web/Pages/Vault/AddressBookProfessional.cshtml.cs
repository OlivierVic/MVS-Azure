...
{
    public class AddressBookProfessionalModel : PageModel
    {
        ...
        public AddressBookProfessionalModel(IVaultService folderService, IVaultContactService contactService, IJobProfessionelService jobService, IConfiguration configuration)
        {
        ...
        public async Task OnGetAsync(string vaultId)
        {
            ...
            this._breadcrumb.Add(this.Url.Page("/Vault/AddressBookProfessional", new { vaultId }), "Carnet d'adresses des professionnels");
        ...
        public async Task<JsonResult> OnGetContactPro(string vaultId, int currentPage, int nbElem = 8)
        {
            Specification<Common.Models.VaultContact> spec = new(c => c.VaultId == vaultId && c.Ispro);
