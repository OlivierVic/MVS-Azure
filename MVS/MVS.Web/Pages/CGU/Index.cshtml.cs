...
namespace MVS.Web.Pages.CGU
{
    public class IndexModel : PageModel
    {
        ...
        {
            this._fileURL = this.Url.PageLink("/CGU/Index", "File");
            ...
            this._breadcrumb.Add("/CGU", "Conditions Générales D’utilisation");
        }

        public IActionResult OnGetFile()
        {
            string webRootPath = this._webHostEnvironment.WebRootPath;
            string filePath = Path.Combine(webRootPath, "documents", "20220722 - CGU Alix Care en ligne.pdf");
