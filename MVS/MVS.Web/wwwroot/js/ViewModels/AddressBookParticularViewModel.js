var AddressBookParticularViewModel = null;
...
function addressBookParticularViewModel(vaultId, kinships) {
    self = this;
    ...
    self.getContacts = function () {
        $.ajax({
            url: '/Vault/AddressBookParticular?handler=ContactParticular',
            type: 'GET',
    ...
    AddressBookParticularViewModel = self;
}
